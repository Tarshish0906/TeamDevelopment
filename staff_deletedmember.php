...
if ($status == false) {
  ...
  foreach ($result as $record) {
    ...
    $output .= "<td><a href='record.php?id={$record["id"]}'>タイムカード</a></td>";
...
<head>
  ...
  <title>退会者リスト（一覧画面）</title>
</head>

<body class="m-5">
  <fieldset>
    <legend>退会者リスト（一覧画面）</legend>
    <a href="staff_read.php" class="btn btn-primary">継続会員一覧</a>
